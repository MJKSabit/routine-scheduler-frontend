...
export const getSessionalPreferencesForm = (form_id) =>
  axios.get(api_url(`/forms/sessional-pref/${form_id}`)).then((res) => res.data.data);

export const submitSessionalPreferencesForm = (form_id, data) =>
  axios.put(api_url(`/forms/sessional-pref/${form_id}`), data).then((res) => res.data);
...
export const submitTheoryScheduleForm = (form_id, data) =>
  axios
    .put(api_url(`/forms/theory-sched/${form_id}`), data)
    .then((res) => res.data);
